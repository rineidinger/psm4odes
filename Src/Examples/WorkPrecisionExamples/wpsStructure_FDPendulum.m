...
% This version with more detailed labeling.
...
plotwps(solved, 1:numsolvers, titlename, makecodetime,[0,15,-.001,.05],[0,15,-100,7000]);  % may add arguments for manual axislimits
